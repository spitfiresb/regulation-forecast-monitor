-- Rank actual word matches above partial strings; APOR must not match vapor.
begin;
create or replace function public.search_rule_catalog(p_query text default '',p_agency text default null,p_limit integer default 10,p_offset integer default 0)
